const miModulo = (() => { "use strict"; let e = []; const t = ["C", "D", "H", "S"],
        n = ["A", "J", "Q", "K"]; let o = []; const r = document.querySelector("#btnPedir"),
        ...
        d = () => { e = []; for (let n = 2; n <= 10; n++)
                for (let o of t) e.push(n + o); for (let o of t)
                for (let t of n) e.push(t + o); return _.shuffle(e) },
        ...
        u = (e, t) => { const n = document.createElement("img");
            n.src = `assets/cartas/${e}.png`, n.classList.add("carta"), l[t].append(n) },
        g = e => { let t = 0;
            do { const e = c();
                t = i(e, o.length - 1), u(e, o.length - 1) } while (t < e && e <= 21);
            (() => { const [e, t] = o;
            ...
            t = i(e, 0);
        u(e, 0), t > 21 ? (console.warn("Lo siento mucho, perdiste"), r.disabled = !0, a.disabled = !0, g(t)) : 21 === t && (console.warn("21, genial!"), r.disabled = !0, a.disabled = !0, g(t)) }), a.addEventListener("click", () => { r.disabled = !0, a.disabled = !0, g(o[0]) }), { nuevoJuego: (t = 2) => { e = d(), o = []; for (let e = 0; e < t; e++) o.push(0);
